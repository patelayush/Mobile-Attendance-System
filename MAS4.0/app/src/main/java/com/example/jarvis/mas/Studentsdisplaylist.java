 ...
 */
public class Studentsdisplaylist extends ArrayAdapter<String> {
    ArrayList<String> list=new ArrayList<>();
    Context context1;
    int subject;

    ArrayList<Student> students=new ArrayList<>();
    public Studentsdisplaylist(Context context, ArrayList<String> list) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        cid=Editstudents.getInstance().subject;
